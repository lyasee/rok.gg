<script>
  import {getNationImage} from '../../../routes/commander/data/utils';
...
<div
  ...
  <a rel="prefetch" href="/v2/commander/{id}" style="height: 100%; width: 100%; padding: 16px 0;">
  ...
  <div style="position: absolute; top: 4px; right: 8px;">
    ...
    {:else}
      <span
        style="color: #fff; font-weight: bold; font-size: 24px;">{grade === '' ? '-' : grade}</span>
    {/if}
  </div>
</div>
