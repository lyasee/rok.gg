...
const temp = {
  name: COMMANDER_NAME,
  nickname: '정복의 아버지',
  image: commanderUrl + 'baibars.png',
  thumbnail: '',
  basePower: 600,
  grade: RANK_C_PLUS,
  rarity: '에픽',
  ...
  skills: [
    {
      ...
      image: skillUrl + 'baibars-skill-1.png',
      skillPreviews: [
        {
          name: '즉시 피해량',
    ...
    },
    {
      ...
      image: skillUrl + 'baibars-skill-2.png',
      skillPreviews: [
        {
          name: '기마병 공격력 증가',
    ...
    },
    {
      ...
      image: skillUrl + 'baibars-skill-3.png',
      skillPreviews: [
        {
          name: '공격력 감소',
    ...
    },
    {
      ...
      image: skillUrl + 'baibars-skill-4.png',
      skillPreviews: [
        {
          name: '치료량',
    ...
    },
    {
      ...
      name: '태양을 가리는 힘',
      description: '',
      image: skillUrl + 'baibars-skill-5.png',
